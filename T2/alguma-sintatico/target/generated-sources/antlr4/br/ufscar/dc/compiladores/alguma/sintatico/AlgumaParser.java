...
public class AlgumaParser extends Parser {
	...
	public static final int
		...
		FALSO=36, VERDADEIRO=37, MAIS=38, MENOS=39, MULT=40, DIV=41, MOD=42, MENOR=43, 
		MAIOR=44, MENOR_IGUAL=45, MAIOR_IGUAL=46, IGUAL=47, DIFERENTE=48, DOIS_PONTOS=49, 
		ABRE_PAR=50, FECHA_PAR=51, VIRGULA=52, INTERVALO=53, ATRIBUICAO=54, PONTEIRO=55, 
		REFERENCIA=56, PONTO=57, ABRE_COLCH=58, FECHA_COLCH=59, NUM_REAL=60, NUM_INT=61, 
		CADEIA_INACABADA=62, CADEIA=63, IDENT=64, COMENTARIO_INACABADO=65, COMENTARIO=66, 
		WS=67, ERROR=68;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"FALSO", "VERDADEIRO", "MAIS", "MENOS", "MULT", "DIV", "MOD", "MENOR", 
			"MAIOR", "MENOR_IGUAL", "MAIOR_IGUAL", "IGUAL", "DIFERENTE", "DOIS_PONTOS", 
			"ABRE_PAR", "FECHA_PAR", "VIRGULA", "INTERVALO", "ATRIBUICAO", "PONTEIRO", 
			"REFERENCIA", "PONTO", "ABRE_COLCH", "FECHA_COLCH", "NUM_REAL", "NUM_INT", 
	...
	public final Declaracao_globalContext declaracao_global() throws RecognitionException {
		...
		try {
			...
			case PROCEDIMENTO:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la - 4)) & ~0x3f) == 0 && ((1L << (_la - 4)) & 1155173305495659011L) != 0) {
					{
					{
					setState(199);
					cmd();
